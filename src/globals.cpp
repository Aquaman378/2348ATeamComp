...
pros::Motor LeftFront(-20, pros::v5::MotorGears::green, pros::v5::MotorUnits::degrees);
pros::Motor LeftBack(-10, pros::v5::MotorGears::green, pros::v5::MotorUnits::degrees);
pros::Motor RightBack(8, pros::v5::MotorGears::green, pros::v5::MotorUnits::degrees);
pros::Motor IntakeMotor(-9, pros::v5::MotorGears::red, pros::v5::MotorUnits::degrees);
...
pros::MotorGroup drive_left({LeftFront.get_port(), LeftBack.get_port()});
pros::MotorGroup drive_right({RightFront.get_port(), RightBack.get_port()});
...
lemlib::OdomSensors sensors{
    ...
    nullptr,         // we don't have a second tracking wheel, so it's set to nullptr
